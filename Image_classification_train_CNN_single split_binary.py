...
364 and 354 validation images for MVM- and MVM+, respectively.
364 and 346 test images for MVM- and MVM+, respectively.
1785 and 1572 train images for MVM- and MVM+, respectively.
"""
...
training_set = train_datagen.flow_from_directory('CNN_MVM/train_O_70',
                                                 target_size = (600, 600),
                                                 batch_size = 32,
                                                 class_mode = 'binary')
...
test_set = test_datagen.flow_from_directory('CNN_MVM/val_15',
                                            target_size = (600, 600),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
# Compiling the CNN
cnn.compile(optimizer = custom_optimizer, loss = 'binary_crossentropy', metrics = ['accuracy'])
...
#Save the model
cnn.save('PE_classification_CNN_MVM.h5')